...
import cz.oneblock.core.util.ComponentUtil;
...
public record Message(String sound, Float pitch, Float volume, List<TextComponent> text, TextComponent title,
    ...
    public Message format(Object... replacements) {
        ...
        return new Message(
                ...
                pitch,
                volume,
                ComponentUtil.formatComponents(text, replaceMap),
                ComponentUtil.formatComponent(title, replaceMap),
                ComponentUtil.formatComponent(subtitle, replaceMap),
                fadeIn,
                stay,
                fadeOut,
                presenter
    ...
    public Message format(Object key, Component replacement) {
        ...
        return new Message(
                ...
                pitch,
                volume,
                ComponentUtil.formatComponents(text, keyName, replacement),
                ComponentUtil.formatComponent(title, keyName, replacement),
                ComponentUtil.formatComponent(subtitle, keyName, replacement),
                fadeIn,
                stay,
                fadeOut,
                presenter
